...
export interface EventHandle {
    ...
    OnUserBiddingRejectedReOffer(client: Client, param: RoomParam, message: Message<UserBiddingRejectedReOffer>, response: ResponseMessage): void;
    OnUserBiddingInitiateCounteroffer(client: Client, param: RoomParam, message: Message<UserBiddingInitiateCounteroffer>, response: ResponseMessage): void;
